...
import { TestingTxData } from "../transactionData/TrxData";
import Link from "next/link";

export default function Testing() {
  const top7TxData = TestingTxData.slice(0, 7); // Fetching only the first five transactions
  const moreThanSeven = TestingTxData.length > 7;
